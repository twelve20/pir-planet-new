...
const products = {
    ...
    20: {
        ...
        description: 'Клей полиуретановый (клей-пена) в аэрозольной упаковке с профессиональным клапаном на основе однокомпонентной полиуретановой системы для приклейки плит PIR с обкладкой из стеклохолста (СХМ/СХМ) или фольги (Ф/Ф) к различным поверхностям: битумный ковер, бетон, кирпич, штукатурка и др.',
        specs: {
            'Производитель': 'Технониколь',
            'Объем баллона': '1000 мл',
            'Применение': 'Приклейка PIR плит',
            'Температура эксплуатации': 'от -60°С до +90°С',
            'Поверхности': 'Битум, бетон, кирпич, штукатурка'
        },
        features: [
            'Профессиональный клапан',
            'Высокая адгезия к различным материалам',
            'Подходит для фольгированных и стеклохолст плит',
            'Быстрое схватывание',
            'Экономичный расход'
        ]
    },
