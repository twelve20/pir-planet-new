...
const products = {
    ...
    17: {
        ...
        specs: {
            ...
            'Применение': 'Проклейка стыков PIR плит',
    ...
    20: {
        ...
        description: 'Клей полиуретановый (клей-пена) в аэрозольной упаковке с профессиональным клапаном на основе однокомпонентной полиуретановой системы для приклейки плит LOGICPIR с обложкой из стеклохолста (СХМ/СХМ) к различным поверхностям: битумный ковер, бетон, кирпич, штукатурка и др. Универсальный всесезонный клей, обладает хорошей устойчивостью к влажности, плесени, старению, высокой адгезией к бетону, цементным штукатуркам и другим минеральным основаниям. Степень расширения клея-пены позволяет компенсировать перепады высот в 15–20 мм. Цвет – голубой.',
        specs: {
            'Бренд': 'ТехноНИКОЛЬ',
            'Страна происхождения': 'Россия',
            'Линейка продукции': 'ТЕХНОНИКОЛЬ Premium',
            'Тип материала': 'Клей-пены',
            'Группа горючести': 'Г4',
            'Группа воспламеняемости': 'В3',
            'Цвет материала': 'Голубой',
            'Объем тары': '1000 мл',
            'Форма выпуска': 'Баллон',
            'Тип конструкции': 'Внутренняя стена, плоская крыша',
            'Прочность сцепления с бетоном': 'Не менее 0.14 МПа',
            'Время отлипа при (23±5)°С': 'Не более 10 мин',
            'Время полной полимеризации': 'Не более 24 часов',
            'Выход из баллона (ширина 30мм)': 'Не менее 34 м.п.',
            'Температура применения': 'от -10°С до +35°С',
            'Степень эвакуации содержимого': 'Не менее 94%',
            'Срок хранения': '18 месяцев',
            'Температура хранения': 'от +5°С до +25°С'
        },
        features: [
            'Универсальный всесезонный клей',
            'Высокая адгезия к минеральным основаниям',
            'Устойчивость к влажности, плесени, старению',
            'Компенсирует перепады высот 15-20 мм',
            'Выход из баллона не менее 34 м.п.',
            'Профессиональный клапан',
            'Подходит для стеклохолста и дерева'
        ]
    },
